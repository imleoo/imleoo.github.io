---
layout: single
title: "使用Claude Router搭建本地Claude Code服务，借助GPT-OSS:20B模型每日节省30美金"
...
作为一名AI技术从业者，我每天都需要大量使用Claude Code进行编程和代码审查。然而，随着使用频率的增加，API费用也水涨船高——每天约30美金的支出成为了不可忽视的成本负担。
...
|------|-----------|----------|------|
| 日均费用 | $30 | $0.50 (电费) | $29.50 |
| 月均费用 | $900 | $15 | $885 |
| 年均费用 | $10,950 | $180 | $10,770 |
